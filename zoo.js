...
// animal1.sleep();
console.log("==========bird1==========");
var bird1 = new Bird("Bird1", 2, "F", 5);
// bird1.fly(); //fly() no longer available in Bird
bird1.eat();
bird1.sleep();
console.log("==========fish1==========");
var fish1 = new Fish("fish1", 3, "M", 2);
fish1.swim();
fish1.eat();
fish1.sleep();
moveAnimals(fish1);
console.log("==========chicken1==========");
var chicken1 = new Chicken("chicken1", 1, "M", 5); //You can either use chicken1:Bird or chicken1:Chicken 
chicken1.eat();
// chicken1.fly();//Chicken can't fly
moveAnimals(chicken1);
console.log("==========sparrow1==========");
var sparrow1 = new Sparrow("sparrow1", 2, "F", 1);
